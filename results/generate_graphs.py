...
with open("results/data/unet-training-loss.json") as UL:
    unet_results.loss = np.array(json.load(UL)).T.tolist()

with open("results/data/unet-validation-mean-dice.json") as UV:
    unet_results.validation = np.array(json.load(UV)).T.tolist()

with open("results/data/segresnet-training-loss.json") as SL:
    segresnet_results.loss = np.array(json.load(SL)).T.tolist()

with open("results/data/segresnet-validation-mean-dice.json") as SV:
